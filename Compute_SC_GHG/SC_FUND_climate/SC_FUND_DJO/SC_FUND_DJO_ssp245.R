...
dscc_total = as.data.table(matrix(nrow = length(pro_years)*Country_num,ncol = 2));
colnames(dscc_total) = c("ISO3","year");
for (i in 1:Country_num) {
  dscc_total$ISO3[((i-1)*Year_num+1):(i*Year_num)] = T_downscale_country$ISO3[i];
  dscc_total$year[((i-1)*Year_num+1):(i*Year_num)] = pro_years;
}
...
write.csv(CSC_CO2,"Compute_SC_GHG/SC_FUND_climate/SC_FUND_DJO/ssp245/CSC_CO2_FUND_DJO.csv",quote = F,row.names = F)
write.csv(WSC_CO2,"Compute_SC_GHG/SC_FUND_climate/SC_FUND_DJO/ssp245/WSC_CO2_FUND_DJO.csv",quote = F,row.names = F)
write.csv(CSC_CH4,"Compute_SC_GHG/SC_FUND_climate/SC_FUND_DJO/ssp245/CSC_CH4_FUND_DJO.csv",quote = F,row.names = F)
write.csv(WSC_CH4,"Compute_SC_GHG/SC_FUND_climate/SC_FUND_DJO/ssp245/WSC_CH4_FUND_DJO.csv",quote = F,row.names = F)
write.csv(CSC_N2O,"Compute_SC_GHG/SC_FUND_climate/SC_FUND_DJO/ssp245/CSC_N2O_FUND_DJO.csv",quote = F,row.names = F)
write.csv(WSC_N2O,"Compute_SC_GHG/SC_FUND_climate/SC_FUND_DJO/ssp245/WSC_N2O_FUND_DJO.csv",quote = F,row.names = F)

write.csv(Country_target_gdpcap_base,"Compute_SC_GHG/SC_FUND_climate/SC_FUND_DJO/ssp245/gdpcap_base_FUND_DJO.csv",quote = F,row.names = F)
write.csv(Country_target_gdpcap_cc,"Compute_SC_GHG/SC_FUND_climate/SC_FUND_DJO/ssp245/gdpcap_cc_FUND_DJO.csv",quote = F,row.names = F)
write.csv(Country_target_gdpcap_imp_CO2,"Compute_SC_GHG/SC_FUND_climate/SC_FUND_DJO/ssp245/gdpcap_imp_CO2_FUND_DJO.csv",quote = F,row.names = F)
write.csv(Country_target_gdpcap_imp_CH4,"Compute_SC_GHG/SC_FUND_climate/SC_FUND_DJO/ssp245/gdpcap_imp_CH4_FUND_DJO.csv",quote = F,row.names = F)
write.csv(Country_target_gdpcap_imp_N2O,"Compute_SC_GHG/SC_FUND_climate/SC_FUND_DJO/ssp245/gdpcap_imp_N2O_FUND_DJO.csv",quote = F,row.names = F)
write.csv(Global_damage_base,"Compute_SC_GHG/SC_FUND_climate/SC_FUND_DJO/ssp245/Global_damage_base_FUND_DJO.csv",quote = F,row.names = F)
write.csv(Global_damage_imp_CO2,"Compute_SC_GHG/SC_FUND_climate/SC_FUND_DJO/ssp245/Global_damage_imp_CO2_FUND_DJO.csv",quote = F,row.names = F)
write.csv(Global_damage_imp_CH4,"Compute_SC_GHG/SC_FUND_climate/SC_FUND_DJO/ssp245/Global_damage_imp_CH4_FUND_DJO.csv",quote = F,row.names = F)
write.csv(Global_damage_imp_N2O,"Compute_SC_GHG/SC_FUND_climate/SC_FUND_DJO/ssp245/Global_damage_imp_N2O_FUND_DJO.csv",quote = F,row.names = F)
