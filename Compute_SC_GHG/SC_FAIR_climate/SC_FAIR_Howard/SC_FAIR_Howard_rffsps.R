...
write.csv(SC_CO2_total,"Compute_SC_GHG/SC_FAIR_climate/SC_FAIR_Howard/rffsps/SC_CO2_total_FAIR_Howard.csv",quote = F,row.names = F)
write.csv(SC_CH4_total,"Compute_SC_GHG/SC_FAIR_climate/SC_FAIR_Howard/rffsps/SC_CH4_total_FAIR_Howard.csv",quote = F,row.names = F)
write.csv(SC_N2O_total,"Compute_SC_GHG/SC_FAIR_climate/SC_FAIR_Howard/rffsps/SC_N2O_total_FAIR_Howard.csv",quote = F,row.names = F)

write.csv(Global_Damage_base,"Compute_SC_GHG/SC_FAIR_climate/SC_FAIR_Howard/rffsps/Global_Damage_base_FAIR_Howard.csv",quote = F,row.names = F)
write.csv(Global_Damage_impulse_CO2,"Compute_SC_GHG/SC_FAIR_climate/SC_FAIR_Howard/rffsps/Global_Damage_impulse_CO2_FAIR_Howard.csv",quote = F,row.names = F)
write.csv(Global_Damage_impulse_CH4,"Compute_SC_GHG/SC_FAIR_climate/SC_FAIR_Howard/rffsps/Global_Damage_impulse_CH4_FAIR_Howard.csv",quote = F,row.names = F)
write.csv(Global_Damage_impulse_N2O,"Compute_SC_GHG/SC_FAIR_climate/SC_FAIR_Howard/rffsps/Global_Damage_impulse_N2O_FAIR_Howard.csv",quote = F,row.names = F)
