...
for (run_time in 1:simulation_no) {
    ...
    Global_gdp_base[run_time,] = res1.p[[run_time]][[6]]$global_gdp;
...
write.csv(CSC_CO2,"Compute_SC_GHG/SC_FAIR_climate/SC_FAIR_DJO/rffsps/CSC_CO2_FAIR_DJO.csv",quote = F,row.names = F)
write.csv(WSC_CO2,"Compute_SC_GHG/SC_FAIR_climate/SC_FAIR_DJO/rffsps/WSC_CO2_FAIR_DJO.csv",quote = F,row.names = F)
write.csv(CSC_CH4,"Compute_SC_GHG/SC_FAIR_climate/SC_FAIR_DJO/rffsps/CSC_CH4_FAIR_DJO.csv",quote = F,row.names = F)
write.csv(WSC_CH4,"Compute_SC_GHG/SC_FAIR_climate/SC_FAIR_DJO/rffsps/WSC_CH4_FAIR_DJO.csv",quote = F,row.names = F)
write.csv(CSC_N2O,"Compute_SC_GHG/SC_FAIR_climate/SC_FAIR_DJO/rffsps/CSC_N2O_FAIR_DJO.csv",quote = F,row.names = F)
write.csv(WSC_N2O,"Compute_SC_GHG/SC_FAIR_climate/SC_FAIR_DJO/rffsps/WSC_N2O_FAIR_DJO.csv",quote = F,row.names = F)

write.csv(Country_target_gdpcap_base,"Compute_SC_GHG/SC_FAIR_climate/SC_FAIR_DJO/rffsps/gdpcap_base_FAIR_DJO.csv",quote = F,row.names = F)
write.csv(Country_target_gdpcap_cc,"Compute_SC_GHG/SC_FAIR_climate/SC_FAIR_DJO/rffsps/gdpcap_cc_FAIR_DJO.csv",quote = F,row.names = F)
write.csv(Country_target_gdpcap_imp_CO2,"Compute_SC_GHG/SC_FAIR_climate/SC_FAIR_DJO/rffsps/gdpcap_imp_CO2_FAIR_DJO.csv",quote = F,row.names = F)
write.csv(Country_target_gdpcap_imp_CH4,"Compute_SC_GHG/SC_FAIR_climate/SC_FAIR_DJO/rffsps/gdpcap_imp_CH4_FAIR_DJO.csv",quote = F,row.names = F)
write.csv(Country_target_gdpcap_imp_N2O,"Compute_SC_GHG/SC_FAIR_climate/SC_FAIR_DJO/rffsps/gdpcap_imp_N2O_FAIR_DJO.csv",quote = F,row.names = F)

write.csv(Global_gdp_base,"Compute_SC_GHG/SC_FAIR_climate/SC_FAIR_DJO/rffsps/Global_gdp_base_FAIR_DJO.csv",quote = F,row.names = F)
write.csv(Global_damage_base,"Compute_SC_GHG/SC_FAIR_climate/SC_FAIR_DJO/rffsps/Global_damage_base_FAIR_DJO.csv",quote = F,row.names = F)
write.csv(Global_damage_imp_CO2,"Compute_SC_GHG/SC_FAIR_climate/SC_FAIR_DJO/rffsps/Global_damage_imp_CO2_FAIR_DJO.csv",quote = F,row.names = F)
write.csv(Global_damage_imp_CH4,"Compute_SC_GHG/SC_FAIR_climate/SC_FAIR_DJO/rffsps/Global_damage_imp_CH4_FAIR_DJO.csv",quote = F,row.names = F)
write.csv(Global_damage_imp_N2O,"Compute_SC_GHG/SC_FAIR_climate/SC_FAIR_DJO/rffsps/Global_damage_imp_N2O_FAIR_DJO.csv",quote = F,row.names = F)
