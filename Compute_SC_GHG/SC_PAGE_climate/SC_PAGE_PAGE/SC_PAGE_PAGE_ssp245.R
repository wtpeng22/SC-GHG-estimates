...
Monte_Carlo_T <-function(){
  ...
  if(MarginalEmission_CO2 == FALSE & MarginalEmission_CH4 == FALSE & MarginalEmission_N2O == FALSE){
    rt_g_globaltemperature <<- PAGE_data_T_ssp245_base[,target_climate];
    s_sealevel <<- PAGE_data_S_ssp245_base[,target_climate]/100;
  }
  
  if(MarginalEmission_CO2 == TRUE & MarginalEmission_CH4 == FALSE & MarginalEmission_N2O == FALSE){
    rt_g_globaltemperature <<- PAGE_data_T_ssp245_CO2[,target_climate];
    s_sealevel <<- PAGE_data_S_ssp245_CO2[,target_climate]/100;
  }
  
  if(MarginalEmission_CO2 == FALSE & MarginalEmission_CH4 == TRUE & MarginalEmission_N2O == FALSE){
    rt_g_globaltemperature <<- PAGE_data_T_ssp245_CH4[,target_climate];
    s_sealevel <<- PAGE_data_S_ssp245_CH4[,target_climate]/100;
  }
  
  if(MarginalEmission_CO2 == FALSE & MarginalEmission_CH4 == FALSE & MarginalEmission_N2O == TRUE){
    rt_g_globaltemperature <<- PAGE_data_T_ssp245_N2O[,target_climate];
    s_sealevel <<- PAGE_data_S_ssp245_N2O[,target_climate]/100;
  }
}
...
write.csv(SC_CO2,"Compute_SC_GHG/SC_PAGE_climate/SC_PAGE_PAGE/ssp245/SC_CO2_PAGE_PAGE.csv",quote = F,row.names = F)
write.csv(SC_CH4,"Compute_SC_GHG/SC_PAGE_climate/SC_PAGE_PAGE/ssp245/SC_CH4_PAGE_PAGE.csv",quote = F,row.names = F)
write.csv(SC_N2O,"Compute_SC_GHG/SC_PAGE_climate/SC_PAGE_PAGE/ssp245/SC_N2O_PAGE_PAGE.csv",quote = F,row.names = F)
write.csv(Global_Damage_base,"Compute_SC_GHG/SC_PAGE_climate/SC_PAGE_PAGE/ssp245/Global_damage_base_PAGE_PAGE.csv",quote = F,row.names = F)
write.csv(Global_Damage_impulse_CO2,"Compute_SC_GHG/SC_PAGE_climate/SC_PAGE_PAGE/ssp245/Global_damage_impulse_CO2_PAGE_PAGE.csv",quote = F,row.names = F)
write.csv(Global_Damage_impulse_CH4,"Compute_SC_GHG/SC_PAGE_climate/SC_PAGE_PAGE/ssp245/Global_damage_impulse_CH4_PAGE_PAGE.csv",quote = F,row.names = F)
write.csv(Global_Damage_impulse_N2O,"Compute_SC_GHG/SC_PAGE_climate/SC_PAGE_PAGE/ssp245/Global_damage_impulse_N2O_PAGE_PAGE.csv",quote = F,row.names = F)
