...
Monte_Carlo_T <-function(){
  ...
  if(MarginalEmission_CO2 == TRUE & MarginalEmission_CH4 == FALSE & MarginalEmission_N2O == FALSE){
    ssp_glob_temp_target <<- PAGE_data_T_ssp245_base[,target_climate];
    ssp_glob_temp_pulse_target <<- PAGE_data_T_ssp245_CO2[,target_climate];
  }
  
  if(MarginalEmission_CO2 == FALSE & MarginalEmission_CH4 == TRUE & MarginalEmission_N2O == FALSE){
    ssp_glob_temp_target <<- PAGE_data_T_ssp245_base[,target_climate];
    ssp_glob_temp_pulse_target <<- PAGE_data_T_ssp245_CH4[,target_climate];
  }
  
  if(MarginalEmission_CO2 == FALSE & MarginalEmission_CH4 == FALSE & MarginalEmission_N2O == TRUE){
    ssp_glob_temp_target <<- PAGE_data_T_ssp245_base[,target_climate];
    ssp_glob_temp_pulse_target <<- PAGE_data_T_ssp245_N2O[,target_climate];
  }
...
write.csv(CSC_CO2,"Compute_SC_GHG/SC_PAGE_climate/SC_PAGE_BHM/ssp245/lag5/CSC_CO2_PAGE_BHM.csv",quote = F,row.names = F)
write.csv(WSC_CO2,"Compute_SC_GHG/SC_PAGE_climate/SC_PAGE_BHM/ssp245/lag5/WSC_CO2_PAGE_BHM.csv",quote = F,row.names = F)
write.csv(CSC_CH4,"Compute_SC_GHG/SC_PAGE_climate/SC_PAGE_BHM/ssp245/lag5/CSC_CH4_PAGE_BHM.csv",quote = F,row.names = F)
write.csv(WSC_CH4,"Compute_SC_GHG/SC_PAGE_climate/SC_PAGE_BHM/ssp245/lag5/WSC_CH4_PAGE_BHM.csv",quote = F,row.names = F)
write.csv(CSC_N2O,"Compute_SC_GHG/SC_PAGE_climate/SC_PAGE_BHM/ssp245/lag5/CSC_N2O_PAGE_BHM.csv",quote = F,row.names = F)
write.csv(WSC_N2O,"Compute_SC_GHG/SC_PAGE_climate/SC_PAGE_BHM/ssp245/lag5/WSC_N2O_PAGE_BHM.csv",quote = F,row.names = F)

write.csv(Country_target_gdpcap_base,"Compute_SC_GHG/SC_PAGE_climate/SC_PAGE_BHM/ssp245/lag5/gdpcap_base_PAGE_BHM.csv",quote = F,row.names = F)
write.csv(Country_target_gdpcap_cc,"Compute_SC_GHG/SC_PAGE_climate/SC_PAGE_BHM/ssp245/lag5/gdpcap_cc_PAGE_BHM.csv",quote = F,row.names = F)
write.csv(Country_target_gdpcap_imp_CO2,"Compute_SC_GHG/SC_PAGE_climate/SC_PAGE_BHM/ssp245/lag5/gdpcap_imp_CO2_PAGE_BHM.csv",quote = F,row.names = F)
write.csv(Country_target_gdpcap_imp_CH4,"Compute_SC_GHG/SC_PAGE_climate/SC_PAGE_BHM/ssp245/lag5/gdpcap_imp_CH4_PAGE_BHM.csv",quote = F,row.names = F)
write.csv(Country_target_gdpcap_imp_N2O,"Compute_SC_GHG/SC_PAGE_climate/SC_PAGE_BHM/ssp245/lag5/gdpcap_imp_N2O_PAGE_BHM.csv",quote = F,row.names = F)
write.csv(Global_damage_base,"Compute_SC_GHG/SC_PAGE_climate/SC_PAGE_BHM/ssp245/lag5/Global_damage_base_PAGE_BHM.csv",quote = F,row.names = F)
write.csv(Global_damage_imp_CO2,"Compute_SC_GHG/SC_PAGE_climate/SC_PAGE_BHM/ssp245/lag5/Global_damage_imp_CO2_PAGE_BHM.csv",quote = F,row.names = F)
write.csv(Global_damage_imp_CH4,"Compute_SC_GHG/SC_PAGE_climate/SC_PAGE_BHM/ssp245/lag5/Global_damage_imp_CH4_PAGE_BHM.csv",quote = F,row.names = F)
write.csv(Global_damage_imp_N2O,"Compute_SC_GHG/SC_PAGE_climate/SC_PAGE_BHM/ssp245/lag5/Global_damage_imp_N2O_PAGE_BHM.csv",quote = F,row.names = F)
...
write.csv(CSC_CO2,"Compute_SC_GHG/SC_PAGE_climate/SC_PAGE_BHM/ssp245/lag0/CSC_CO2_PAGE_BHM.csv",quote = F,row.names = F)
write.csv(WSC_CO2,"Compute_SC_GHG/SC_PAGE_climate/SC_PAGE_BHM/ssp245/lag0/WSC_CO2_PAGE_BHM.csv",quote = F,row.names = F)
write.csv(CSC_CH4,"Compute_SC_GHG/SC_PAGE_climate/SC_PAGE_BHM/ssp245/lag0/CSC_CH4_PAGE_BHM.csv",quote = F,row.names = F)
write.csv(WSC_CH4,"Compute_SC_GHG/SC_PAGE_climate/SC_PAGE_BHM/ssp245/lag0/WSC_CH4_PAGE_BHM.csv",quote = F,row.names = F)
write.csv(CSC_N2O,"Compute_SC_GHG/SC_PAGE_climate/SC_PAGE_BHM/ssp245/lag0/CSC_N2O_PAGE_BHM.csv",quote = F,row.names = F)
write.csv(WSC_N2O,"Compute_SC_GHG/SC_PAGE_climate/SC_PAGE_BHM/ssp245/lag0/WSC_N2O_PAGE_BHM.csv",quote = F,row.names = F)

write.csv(Country_target_gdpcap_base,"Compute_SC_GHG/SC_PAGE_climate/SC_PAGE_BHM/ssp245/lag0/gdpcap_base_PAGE_BHM.csv",quote = F,row.names = F)
write.csv(Country_target_gdpcap_cc,"Compute_SC_GHG/SC_PAGE_climate/SC_PAGE_BHM/ssp245/lag0/gdpcap_cc_PAGE_BHM.csv",quote = F,row.names = F)
write.csv(Country_target_gdpcap_imp_CO2,"Compute_SC_GHG/SC_PAGE_climate/SC_PAGE_BHM/ssp245/lag0/gdpcap_imp_CO2_PAGE_BHM.csv",quote = F,row.names = F)
write.csv(Country_target_gdpcap_imp_CH4,"Compute_SC_GHG/SC_PAGE_climate/SC_PAGE_BHM/ssp245/lag0/gdpcap_imp_CH4_PAGE_BHM.csv",quote = F,row.names = F)
write.csv(Country_target_gdpcap_imp_N2O,"Compute_SC_GHG/SC_PAGE_climate/SC_PAGE_BHM/ssp245/lag0/gdpcap_imp_N2O_PAGE_BHM.csv",quote = F,row.names = F)
write.csv(Global_damage_base,"Compute_SC_GHG/SC_PAGE_climate/SC_PAGE_BHM/ssp245/lag0/Global_damage_base_PAGE_BHM.csv",quote = F,row.names = F)
write.csv(Global_damage_imp_CO2,"Compute_SC_GHG/SC_PAGE_climate/SC_PAGE_BHM/ssp245/lag0/Global_damage_imp_CO2_PAGE_BHM.csv",quote = F,row.names = F)
write.csv(Global_damage_imp_CH4,"Compute_SC_GHG/SC_PAGE_climate/SC_PAGE_BHM/ssp245/lag0/Global_damage_imp_CH4_PAGE_BHM.csv",quote = F,row.names = F)
write.csv(Global_damage_imp_N2O,"Compute_SC_GHG/SC_PAGE_climate/SC_PAGE_BHM/ssp245/lag0/Global_damage_imp_N2O_PAGE_BHM.csv",quote = F,row.names = F)
