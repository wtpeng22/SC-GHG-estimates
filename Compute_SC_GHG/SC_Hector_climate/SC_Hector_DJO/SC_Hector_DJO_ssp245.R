...
write.csv(CSC_CO2,"Compute_SC_GHG/SC_Hector_climate/SC_Hector_DJO/ssp245/CSC_CO2_Hector_DJO.csv",quote = F,row.names = F)
write.csv(WSC_CO2,"Compute_SC_GHG/SC_Hector_climate/SC_Hector_DJO/ssp245/WSC_CO2_Hector_DJO.csv",quote = F,row.names = F)
write.csv(CSC_CH4,"Compute_SC_GHG/SC_Hector_climate/SC_Hector_DJO/ssp245/CSC_CH4_Hector_DJO.csv",quote = F,row.names = F)
write.csv(WSC_CH4,"Compute_SC_GHG/SC_Hector_climate/SC_Hector_DJO/ssp245/WSC_CH4_Hector_DJO.csv",quote = F,row.names = F)
write.csv(CSC_N2O,"Compute_SC_GHG/SC_Hector_climate/SC_Hector_DJO/ssp245/CSC_N2O_Hector_DJO.csv",quote = F,row.names = F)
write.csv(WSC_N2O,"Compute_SC_GHG/SC_Hector_climate/SC_Hector_DJO/ssp245/WSC_N2O_Hector_DJO.csv",quote = F,row.names = F)

write.csv(Country_target_gdpcap_base,"Compute_SC_GHG/SC_Hector_climate/SC_Hector_DJO/ssp245/gdpcap_base_Hector_DJO.csv",quote = F,row.names = F)
write.csv(Country_target_gdpcap_cc,"Compute_SC_GHG/SC_Hector_climate/SC_Hector_DJO/ssp245/gdpcap_cc_Hector_DJO.csv",quote = F,row.names = F)
write.csv(Country_target_gdpcap_imp_CO2,"Compute_SC_GHG/SC_Hector_climate/SC_Hector_DJO/ssp245/gdpcap_imp_CO2_Hector_DJO.csv",quote = F,row.names = F)
write.csv(Country_target_gdpcap_imp_CH4,"Compute_SC_GHG/SC_Hector_climate/SC_Hector_DJO/ssp245/gdpcap_imp_CH4_Hector_DJO.csv",quote = F,row.names = F)
write.csv(Country_target_gdpcap_imp_N2O,"Compute_SC_GHG/SC_Hector_climate/SC_Hector_DJO/ssp245/gdpcap_imp_N2O_Hector_DJO.csv",quote = F,row.names = F)
write.csv(Global_damage_base,"Compute_SC_GHG/SC_Hector_climate/SC_Hector_DJO/ssp245/Global_damage_base_Hector_DJO.csv",quote = F,row.names = F)
write.csv(Global_damage_imp_CO2,"Compute_SC_GHG/SC_Hector_climate/SC_Hector_DJO/ssp245/Global_damage_imp_CO2_Hector_DJO.csv",quote = F,row.names = F)
write.csv(Global_damage_imp_CH4,"Compute_SC_GHG/SC_Hector_climate/SC_Hector_DJO/ssp245/Global_damage_imp_CH4_Hector_DJO.csv",quote = F,row.names = F)
write.csv(Global_damage_imp_N2O,"Compute_SC_GHG/SC_Hector_climate/SC_Hector_DJO/ssp245/Global_damage_imp_N2O_Hector_DJO.csv",quote = F,row.names = F)
