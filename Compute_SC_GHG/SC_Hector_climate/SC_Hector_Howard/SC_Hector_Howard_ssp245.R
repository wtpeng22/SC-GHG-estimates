...
write.csv(SC_CO2_total,"Compute_SC_GHG/SC_Hector_climate/SC_Hector_Howard/ssp245/SC_CO2_total_Hector_Howard.csv",quote = F,row.names = F)
write.csv(SC_CH4_total,"Compute_SC_GHG/SC_Hector_climate/SC_Hector_Howard/ssp245/SC_CH4_total_Hector_Howard.csv",quote = F,row.names = F)
write.csv(SC_N2O_total,"Compute_SC_GHG/SC_Hector_climate/SC_Hector_Howard/ssp245/SC_N2O_total_Hector_Howard.csv",quote = F,row.names = F)

write.csv(Global_Damage_base,"Compute_SC_GHG/SC_Hector_climate/SC_Hector_Howard/ssp245/Global_Damage_base_Hector_Howard.csv",quote = F,row.names = F)
write.csv(Global_Damage_impulse_CO2,"Compute_SC_GHG/SC_Hector_climate/SC_Hector_Howard/ssp245/Global_Damage_impulse_CO2_Hector_Howard.csv",quote = F,row.names = F)
write.csv(Global_Damage_impulse_CH4,"Compute_SC_GHG/SC_Hector_climate/SC_Hector_Howard/ssp245/Global_Damage_impulse_CH4_Hector_Howard.csv",quote = F,row.names = F)
write.csv(Global_Damage_impulse_N2O,"Compute_SC_GHG/SC_Hector_climate/SC_Hector_Howard/ssp245/Global_Damage_impulse_N2O_Hector_Howard.csv",quote = F,row.names = F)
