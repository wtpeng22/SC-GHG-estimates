...
write.csv(SC_CO2_total,"Compute_SC_GHG/SC_MAGICC_climate/SC_MAGICC_DICE/ssp245/SC_CO2_total_MAGICC_DICE.csv",quote = F,row.names = F)
write.csv(SC_CH4_total,"Compute_SC_GHG/SC_MAGICC_climate/SC_MAGICC_DICE/ssp245/SC_CH4_total_MAGICC_DICE.csv",quote = F,row.names = F)
write.csv(SC_N2O_total,"Compute_SC_GHG/SC_MAGICC_climate/SC_MAGICC_DICE/ssp245/SC_N2O_total_MAGICC_DICE.csv",quote = F,row.names = F)

write.csv(Global_Damage_base,"Compute_SC_GHG/SC_MAGICC_climate/SC_MAGICC_DICE/ssp245/Global_Damage_base_MAGICC_DICE.csv",quote = F,row.names = F)
write.csv(Global_Damage_impulse_CO2,"Compute_SC_GHG/SC_MAGICC_climate/SC_MAGICC_DICE/ssp245/Global_Damage_impulse_CO2_MAGICC_DICE.csv",quote = F,row.names = F)
write.csv(Global_Damage_impulse_CH4,"Compute_SC_GHG/SC_MAGICC_climate/SC_MAGICC_DICE/ssp245/Global_Damage_impulse_CH4_MAGICC_DICE.csv",quote = F,row.names = F)
write.csv(Global_Damage_impulse_N2O,"Compute_SC_GHG/SC_MAGICC_climate/SC_MAGICC_DICE/ssp245/Global_Damage_impulse_N2O_MAGICC_DICE.csv",quote = F,row.names = F)
