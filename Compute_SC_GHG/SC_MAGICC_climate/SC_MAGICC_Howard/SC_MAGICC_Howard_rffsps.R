...
Howard_pop_data<-as.matrix(fread("Module/Socioeconomic/outputs/DICE_data/rffsps_global_pop.csv",header = TRUE))
Howard_gdp_data<-as.matrix(fread("Module/Socioeconomic/outputs/DICE_data/rffsps_global_gdp.csv",header = TRUE))
...
for (j in 1:simulation_no) {
    ...
    Howard_data[2,-1] =  Howard_pop_data[,target_sample+1]
    Howard_data[3,-1] =  Howard_gdp_data[,target_sample+1]
...
write.csv(SC_CO2_total,"Compute_SC_GHG/SC_MAGICC_climate/SC_MAGICC_Howard/rffsps/SC_CO2_total_MAGICC_Howard.csv",quote = F,row.names = F)
write.csv(SC_CH4_total,"Compute_SC_GHG/SC_MAGICC_climate/SC_MAGICC_Howard/rffsps/SC_CH4_total_MAGICC_Howard.csv",quote = F,row.names = F)
write.csv(SC_N2O_total,"Compute_SC_GHG/SC_MAGICC_climate/SC_MAGICC_Howard/rffsps/SC_N2O_total_MAGICC_Howard.csv",quote = F,row.names = F)

write.csv(Global_Damage_base,"Compute_SC_GHG/SC_MAGICC_climate/SC_MAGICC_Howard/rffsps/Global_Damage_base_MAGICC_Howard.csv",quote = F,row.names = F)
write.csv(Global_Damage_impulse_CO2,"Compute_SC_GHG/SC_MAGICC_climate/SC_MAGICC_Howard/rffsps/Global_Damage_impulse_CO2_MAGICC_Howard.csv",quote = F,row.names = F)
write.csv(Global_Damage_impulse_CH4,"Compute_SC_GHG/SC_MAGICC_climate/SC_MAGICC_Howard/rffsps/Global_Damage_impulse_CH4_MAGICC_Howard.csv",quote = F,row.names = F)
write.csv(Global_Damage_impulse_N2O,"Compute_SC_GHG/SC_MAGICC_climate/SC_MAGICC_Howard/rffsps/Global_Damage_impulse_N2O_MAGICC_Howard.csv",quote = F,row.names = F)
