...
write.csv(CSC_CO2,"Compute_SC_GHG/SC_MAGICC_climate/SC_MAGICC_DJO/rffsps/CSC_CO2_MAGICC_DJO.csv",quote = F,row.names = F)
write.csv(WSC_CO2,"Compute_SC_GHG/SC_MAGICC_climate/SC_MAGICC_DJO/rffsps/WSC_CO2_MAGICC_DJO.csv",quote = F,row.names = F)
write.csv(CSC_CH4,"Compute_SC_GHG/SC_MAGICC_climate/SC_MAGICC_DJO/rffsps/CSC_CH4_MAGICC_DJO.csv",quote = F,row.names = F)
write.csv(WSC_CH4,"Compute_SC_GHG/SC_MAGICC_climate/SC_MAGICC_DJO/rffsps/WSC_CH4_MAGICC_DJO.csv",quote = F,row.names = F)
write.csv(CSC_N2O,"Compute_SC_GHG/SC_MAGICC_climate/SC_MAGICC_DJO/rffsps/CSC_N2O_MAGICC_DJO.csv",quote = F,row.names = F)
write.csv(WSC_N2O,"Compute_SC_GHG/SC_MAGICC_climate/SC_MAGICC_DJO/rffsps/WSC_N2O_MAGICC_DJO.csv",quote = F,row.names = F)

write.csv(Country_target_gdpcap_base,"Compute_SC_GHG/SC_MAGICC_climate/SC_MAGICC_DJO/rffsps/gdpcap_base_MAGICC_DJO.csv",quote = F,row.names = F)
write.csv(Country_target_gdpcap_cc,"Compute_SC_GHG/SC_MAGICC_climate/SC_MAGICC_DJO/rffsps/gdpcap_cc_MAGICC_DJO.csv",quote = F,row.names = F)
write.csv(Country_target_gdpcap_imp_CO2,"Compute_SC_GHG/SC_MAGICC_climate/SC_MAGICC_DJO/rffsps/gdpcap_imp_CO2_MAGICC_DJO.csv",quote = F,row.names = F)
write.csv(Country_target_gdpcap_imp_CH4,"Compute_SC_GHG/SC_MAGICC_climate/SC_MAGICC_DJO/rffsps/gdpcap_imp_CH4_MAGICC_DJO.csv",quote = F,row.names = F)
write.csv(Country_target_gdpcap_imp_N2O,"Compute_SC_GHG/SC_MAGICC_climate/SC_MAGICC_DJO/rffsps/gdpcap_imp_N2O_MAGICC_DJO.csv",quote = F,row.names = F)

write.csv(Global_gdp_base,"Compute_SC_GHG/SC_MAGICC_climate/SC_MAGICC_DJO/rffsps/Global_gdp_base_MAGICC_DJO.csv",quote = F,row.names = F)
write.csv(Global_damage_base,"Compute_SC_GHG/SC_MAGICC_climate/SC_MAGICC_DJO/rffsps/Global_damage_base_MAGICC_DJO.csv",quote = F,row.names = F)
write.csv(Global_damage_imp_CO2,"Compute_SC_GHG/SC_MAGICC_climate/SC_MAGICC_DJO/rffsps/Global_damage_imp_CO2_MAGICC_DJO.csv",quote = F,row.names = F)
write.csv(Global_damage_imp_CH4,"Compute_SC_GHG/SC_MAGICC_climate/SC_MAGICC_DJO/rffsps/Global_damage_imp_CH4_MAGICC_DJO.csv",quote = F,row.names = F)
write.csv(Global_damage_imp_N2O,"Compute_SC_GHG/SC_MAGICC_climate/SC_MAGICC_DJO/rffsps/Global_damage_imp_N2O_MAGICC_DJO.csv",quote = F,row.names = F)
