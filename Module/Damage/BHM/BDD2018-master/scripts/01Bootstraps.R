...
plot(1:10, (1-exp(-(1:10)*0.00191)),ylim = c(0,0.5))
lines(0.00236*(1:10)^2)

plot(1:10, (1-exp(-0.001*(1:10)-0.00236*(1:10)^2)),ylim = c(0,0.4))
lines(1:10,0.00236*((1:10)^2))
lines(1:10,0-(0-0.05*(1:10)-0.0009*(1:10)^2),color="red")

plot(1:10, (1-exp(seq(10,100,10)*(0.012-0.0005*2*15)*5-0.0005*5^2)),ylim = c(0,1))
