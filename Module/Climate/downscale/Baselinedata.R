...
years_tot_base = 2010:2019 #####2010-2019 average temperature
...
for (mm in 1:12) {
  for (yy in 1:length(years_tot_base)) {
    print(yy)
    time_target = time_weather_brick[(yy-1+109)*12+mm]
...
write.xlsx(temp_pop_baseline_target, "Climate/downscale/Country_level_basetemp.xlsx")
