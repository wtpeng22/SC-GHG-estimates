...
for i in range(sample_num):
    print(i)
    rffsps_path = "".join(["Climate/MAGICC/rffsps/MAGICC_rffsps_", str(scenario_sample[i]), ".csv"])
    emissions_rffsps = pd.read_csv(rffsps_path, header=None)
    emissions_rffsps = np.array(emissions_rffsps)
    rcp45.values[0:161, ] = emissions_rffsps[0:161, ]
...
# C_base_pd.to_csv('Climate/MAGICC/outputs/rffsps/C_base.csv')
# T_base_pd.to_csv('Climate/MAGICC/outputs/rffsps/T_base.csv')
# C_base_pd.to_csv('Climate/MAGICC/outputs/rffsps/C_extra_CO2.csv')
# T_base_pd.to_csv('Climate/MAGICC/outputs/rffsps/T_extra_CO2.csv')
C_base_pd.to_csv('Climate/MAGICC/outputs/rffsps/C_extra_CH4.csv')
T_base_pd.to_csv('Climate/MAGICC/outputs/rffsps/T_extra_CH4.csv')
# C_base_pd.to_csv('Climate/MAGICC/outputs/rffsps/C_extra_N2O.csv')
# T_base_pd.to_csv('Climate/MAGICC/outputs/rffsps/T_extra_N2O.csv')
