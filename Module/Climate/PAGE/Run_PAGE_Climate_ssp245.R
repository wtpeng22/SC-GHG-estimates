...
GHGem<-read.csv("Climate/PAGE/ssp245/emissions_ssp245.csv",header = T,skip = 3);
GHGem=as.matrix(GHGem);
LGem <- read.csv("Climate/PAGE/ssp245/LG_emissions_ssp245.csv");
LGem=LGem$ssp245;
other_gases_forcing<-read.csv("Climate/PAGE/ssp245/otherforcing_ssp245.csv");
...
write.csv(PAGE_temp_base,"Climate/PAGE/outputs/ssp245/T_base.csv",quote = F,row.names = F)
write.csv(PAGE_temp_anomaly_CO2,"Climate/PAGE/outputs/ssp245/T_extra_CO2.csv",quote = F,row.names = F)
write.csv(PAGE_temp_anomaly_CH4,"Climate/PAGE/outputs/ssp245/T_extra_CH4.csv",quote = F,row.names = F)
write.csv(PAGE_temp_anomaly_N2O,"Climate/PAGE/outputs/ssp245/T_extra_N2O.csv",quote = F,row.names = F)

write.csv(PAGE_slr_base,"Climate/PAGE/outputs/ssp245/S_base.csv",quote = F,row.names = F)
write.csv(PAGE_slr_anomaly_CO2,"Climate/PAGE/outputs/ssp245/S_extra_CO2.csv",quote = F,row.names = F)
write.csv(PAGE_slr_anomaly_CH4,"Climate/PAGE/outputs/ssp245/S_extra_CH4.csv",quote = F,row.names = F)
write.csv(PAGE_slr_anomaly_N2O,"Climate/PAGE/outputs/ssp245/S_extra_N2O.csv",quote = F,row.names = F)

write.csv(PAGE_acco2_base,"Climate/PAGE/outputs/ssp245/C_base.csv",quote = F,row.names = F)
write.csv(PAGE_acco2_anomaly_CO2,"Climate/PAGE/outputs/ssp245/C_extra_CO2.csv",quote = F,row.names = F)
write.csv(PAGE_acco2_anomaly_CH4,"Climate/PAGE/outputs/ssp245/C_extra_CH4.csv",quote = F,row.names = F)
write.csv(PAGE_acco2_anomaly_N2O,"Climate/PAGE/outputs/ssp245/C_extra_N2O.csv",quote = F,row.names = F)
