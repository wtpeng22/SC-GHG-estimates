...
GHGem<-read.csv("Climate/FUND/ssp245/emissions_ssp245.csv",header = T,skip = 3);
rfso2<-read.csv("Climate/FUND/ssp245/rfso2_ssp245.csv",header = T);
...
write.csv(FUND_temp_base,"Climate/FUND/outputs/ssp245/T_base.csv",quote = F,row.names = F)
write.csv(FUND_temp_anomaly_CO2,"Climate/FUND/outputs/ssp245/T_extra_CO2.csv",quote = F,row.names = F)
write.csv(FUND_temp_anomaly_CH4,"Climate/FUND/outputs/ssp245/T_extra_CH4.csv",quote = F,row.names = F)
write.csv(FUND_temp_anomaly_N2O,"Climate/FUND/outputs/ssp245/T_extra_N2O.csv",quote = F,row.names = F)

write.csv(FUND_slr_base,"Climate/FUND/outputs/ssp245/S_base.csv",quote = F,row.names = F)
write.csv(FUND_slr_anomaly_CO2,"Climate/FUND/outputs/ssp245/S_extra_CO2.csv",quote = F,row.names = F)
write.csv(FUND_slr_anomaly_CH4,"Climate/FUND/outputs/ssp245/S_extra_CH4.csv",quote = F,row.names = F)
write.csv(FUND_slr_anomaly_N2O,"Climate/FUND/outputs/ssp245/S_extra_N2O.csv",quote = F,row.names = F)

write.csv(FUND_acco2_base,"Climate/FUND/outputs/ssp245/C_base.csv",quote = F,row.names = F)
write.csv(FUND_acco2_anomaly_CO2,"Climate/FUND/outputs/ssp245/C_extra_CO2.csv",quote = F,row.names = F)
write.csv(FUND_acco2_anomaly_CH4,"Climate/FUND/outputs/ssp245/C_extra_CH4.csv",quote = F,row.names = F)
write.csv(FUND_acco2_anomaly_N2O,"Climate/FUND/outputs/ssp245/C_extra_N2O.csv",quote = F,row.names = F)
